const TILES = [
  ...
  {name:"Mediterranean Ave",type:"land",price:100,baseRent:10,color:"#9b59b6"},
  {name:"Baltic Ave",type:"land",price:100,baseRent:10,color:"#9b59b6"},
  {name:"Chance",type:"chance",color:"#f1c40f"},
  {name:"Oriental Ave",type:"land",price:140,baseRent:14,color:"#3498db"},
  {name:"Vermont Ave",type:"land",price:140,baseRent:14,color:"#3498db"},
  {name:"Connecticut Ave",type:"land",price:160,baseRent:16,color:"#3498db"},
  {name:"Income Tax",type:"tax",price:0,baseRent:0,color:"#bdc3c7"},
  {name:"Reading Railroad",type:"rail",price:220,baseRent:30,color:"#34495e"},
  {name:"Jail",type:"jail",color:"#e74c3c"},
  {name:"St. James Place",type:"land",price:180,baseRent:18,color:"#e67e22"},
  {name:"Electric Company",type:"utility",price:200,baseRent:25,color:"#95a5a6"},
  {name:"Virginia Ave",type:"land",price:180,baseRent:18,color:"#e67e22"},
  {name:"Pennsylvania Railroad",type:"rail",price:220,baseRent:30,color:"#34495e"},
  {name:"States Ave",type:"land",price:200,baseRent:20,color:"#e67e22"},
  {name:"Maryland Ave",type:"land",price:200,baseRent:20,color:"#e67e22"},
  {name:"Community Chest",type:"chance",color:"#f1c40f"},
  {name:"Lucky Fund",type:"fund",color:"#ecf0f1"},
  {name:"Kentucky Ave",type:"land",price:220,baseRent:22,color:"#e74c3c"},
  {name:"Chance",type:"chance",color:"#f1c40f"},
  {name:"Indiana Ave",type:"land",price:220,baseRent:22,color:"#e74c3c"},
  {name:"Illinois Ave",type:"land",price:240,baseRent:24,color:"#e74c3c"},
  {name:"B&ORailroad",type:"rail",price:220,baseRent:30,color:"#34495e"},
  {name:"Atlantic Ave",type:"land",price:260,baseRent:26,color:"#f39c12"},
  ...
  {name:"Short Line Railroad",type:"rail",price:220,baseRent:30,color:"#34495e"},
  {name:"Pacific Ave",type:"land",price:300,baseRent:30,color:"#27ae60"},
  {name:"Boardwalk",type:"land",price:350,baseRent:35,color:"#27ae60"},
  {name:"North Carolina Ave",type:"land",price:320,baseRent:32,color:"#27ae60"},
  {name:"Pennsylvania Ave",type:"land",price:320,baseRent:32,color:"#27ae60"},
  {name:"Chance",type:"chance",color:"#f1c40f"},
  {name:"Park Place",type:"land",price:400,baseRent:45,color:"#1f618d"},
  {name:"Board Street",type:"land",price:450,baseRent:50,color:"#1f618d"}
];
